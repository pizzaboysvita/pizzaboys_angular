...
export let SalesSummary: ChartOptions | any = {
    series: [{
        type: 'bar',
    ...
    stroke: {
        ...
        curve: 'smooth',
        width: [4, 4, 3],
        colors: ['transparent', 'transparent', "#f4bb55"]
    },
...
export let EmployeesSatisfied: ChartOptions | any = {
    series: [{
        name: 'TEAM A',
        type: 'area',
...
export let Expenses: ChartOptions | any = {
    series: [
        {
            name: "Income",
            type: "line",
...
export let SalesPurchase: ChartOptions | any = {
    series: [{
        name: 'TEAM A',
        type: 'column',
...
export let userPosition: ChartOptions | any = {
    series: [{
